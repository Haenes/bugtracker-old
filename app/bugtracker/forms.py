    ...
    def clean_password1(self):
        ...
        if not validate_password(password1):
            raise ValidationError(
                _("The password doesn't meet the conditions")
                )
...
class UserForm(ModelForm):
    ...
    def clean_first_name(self):
        ...
        if len(first_name) < 2:
            raise ValidationError(
                _("First name must contain at least 2 letters")
                )
    ...
    def clean_last_name(self):
        ...
        if len(last_name) < 2:
            raise ValidationError(
                _("Last name must contain at least 2 letters")
                )
...
class UserPasswordChangeForm(forms.Form):
    ...
    new_password1 = forms.CharField(
        ...
        widget=forms.PasswordInput(
            attrs={
                "class": "col-4 mb-3 form-control bg-body-tertiary",
                "autofocus": True
                }
            ),
        )
    ...
    new_password2 = forms.CharField(
        ...
        max_length=32,
        widget=forms.PasswordInput(
            attrs={"class": "col-2  mb-4 form-control bg-body-tertiary"}
            ),
        )
...
class ProjectDetailsForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "starred": CheckboxInput(
                attrs={
                    "name": "Favorite",
                    "style": "width:20px; height:20px",
                    "class": "form-check-input starred"
                    }
                ),
            }
...
class ProjectModalForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "author": TextInput(),
            "name": TextInput(
                attrs={"class": "form-control bg-body-tertiary"}
                ),
    ...
    class Meta:
        ...
        widgets = {
            ...
            "description": Textarea(
                attrs={"class": "form-control bg-body-tertiary", "rows": "5"}
                ),
            "author": TextInput(),
            }
...
class IssueDetailsForm(ModelForm):
    ...
    class Meta:
        model = Issue
        fields = ["project", "status", "type", "priority",
                  "title", "description", "author"
                  ]
        ...
        widgets = {
            ...
            "priority": Select(
                attrs={"class": "form-select bg-body-tertiary"}
                ),
            "title": TextInput(
                attrs={"class": "form-control bg-body-tertiary"}
                ),
