...
class ProjectModalFormTestCase(TestCase):
    ...
    def test_name_field(self):
        data_invalid = {"author": self.user.id, "name": "Testing", "key": "TESTI", "type": "Fullstack software", "starred":1}
        data_valid = {"author": self.user.id, "name": "Test", "key": "TESTII", "type": "Fullstack software", "starred":1}
    ...
    def test_key_field(self):
        data_invalid = {"author": self.user.id, "name": "Test", "key": "TEST", "type": "Fullstack software", "starred":1}
        data_valid = {"author": self.user.id, "name": "Test", "key": "TESTII", "type": "Fullstack software", "starred":1}

        form_invalid = ProjectModalForm(data_invalid, initial={"author_id": self.user.id})
        form_valid = ProjectModalForm(data_valid, initial={"author_id": self.user.id})
